...
<img src="assets/image-20210520223028487.png" alt="image-20210520223028487" style="zoom:50%;" />



编译器翻译后运行（compilers）：编译后生成目标代码后执行，编译后重新执行不需要重新编译，运行速度较快，但平台通用性不佳。以该方式执行的语言包括：C/C++

<img src="assets/image-20210520223450395.png" alt="image-20210520223450395" style="zoom:50%;" />



两种模式混合运行（Hybrid）:程序运行时同时包含解释和编译。如：Java、JavaScript。

<img src="assets/image-20210520223838138.png" alt="image-20210520223838138" style="zoom:50%;" />
